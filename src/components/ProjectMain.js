...
function ProjectMain() {
  ...
  return (
    <>
     <div className="bg-white grid  grid-cols-1 grid-row-2 md:grid-cols-3 md:grid-rows-2 gap-4 place-content-stretch mt-5 mb-5 border-2 rounded-xl p-5 h-auto max-w-screen-xl">
          ...
          <div className="relative box md:row-start-1 md:row-end-3 border-1 rounded-tr-xl bg-black/70 text-white border-slate-500 flex flex-col justify-center p-2 md:w-auto overflow-hidden top-0 left-0">
            <Circle />
            <div className="z-10 h-auto flex flex-col justify-around">
              <div className=" p-1 h-auto flex flex-col ">
                <div className={`p-1 w-full`}>
                  <h3 className="text-center font-bold">{ProjectData[num].projectName}</h3>
