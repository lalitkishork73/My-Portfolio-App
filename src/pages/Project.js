        ...
        <div className="bg-white grid  grid-cols-1 grid-row-2 md:grid-cols-3 md:grid-rows-2 gap-4 place-content-stretch mt-5 mb-5 border-2 rounded-xl p-5 h-auto max-w-screen-xl">
          <div className="relative box md:row-start-1 md:row-end-3 md:col-start-1 md:col-end-3 pb-[56.22%]">
            ...
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/LIIDh-qI9oI?list=RDLIIDh-qI9oI"
          ...
          <div className="box md:row-start-1 md:row-end-3 border-1 rounded-xl bg-sky-100 border-slate-500 flex flex-col justify-center p-2 md:w-auto ">
